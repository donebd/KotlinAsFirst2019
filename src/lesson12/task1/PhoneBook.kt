...
class PhoneBook {
     ...
     */
    fun phones(name: String): Set<String> = contacts[name] ?: emptySet()
    ...
    fun humanByPhone(phone: String): String? {
        for ((i, j) in contacts) if (j.contains(phone)) return i
        return null
    }
     ...
     */
    override fun equals(other: Any?): Boolean = other is PhoneBook && contacts == other.contacts
